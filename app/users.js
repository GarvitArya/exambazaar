...
router.get('/', function(req, res) {
    user.find({_created: {  $gte : "2016-07-13T00:00:00.000Z", $lte : "2017-07-13T00:00:00.000Z"}}, {userType: 1, basic: 1, mobile: 1, facebook: 1, email: 1, image: 1, fbemail: 1, fbimage: 1, _created: 1}, function(err, docs) {
    if (!err){
        res.json(docs);
    } else {throw err;}
    });
