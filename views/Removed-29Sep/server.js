...
'/charting',
'/claim/:coachingId',
'/coaching/database1/:city',
'/coaching/database2/:city',
'/coaching/providersWithAreas',
'/coachingGroupSummary',
'/contacts',
'/edit/database1/:coachingId',
'/editblog/:blogpostId',
'/error',
'/exam/:examName',
'/extractEmails',
...
'/login',
'/master/:masterId/addMaster',
'/master/:masterId/dashboard',
'/master/:masterId/manageUsers',
'/master/:masterId/sandbox2/:cityName',
'/master/:userId/addInstitute',
'/master/:userId/bulkDisable',
'/partner/:coachingId/offers',
'/partner/:userId/dashboard',
'/privacy',
...
'/thankyou',
'/user/:userId/:reviewId/availoffer',
'/user/:userId/addedInstitutes',
'/user/:userId/addedQuestions',
'/user/:userId/addIntern',
'/user/:userId/assigned',
'/user/:userId/assignedToAddContactInfo',
'/user/:userId/assignedToRate',
'/user/:userId/assignedToVerify',
'/user/:userId/checkLogo/:pageNumber/',
'/user/:userId/coachingGroup',
'/user/:userId/eligibility',
'/user/:userId/filled',
'/user/:userId/filledAll',
'/user/:userId/group',
'/user/:userId/profile',
'/user/:userId/reviewed',
'/user/:userId/sendEmail',
'/user/:userId/shortlisted',
'/user/:userId/suggestCoaching',
'/user/:userId/userMarketing',
'/user/:userId/userSurvey',
'/user/:userId/viewed',
'/verify/:userId/',
