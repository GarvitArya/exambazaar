    ...
    var thisExam = exam
        ...
        if (!err){
            ...
            if(thisExam){
                ...
                var thisExam = exam
                .findOne({'urlslug': examName}, {_id:1, name:1})
                .exec(function (err, thisExam) {
                if (!err){
...
router.get('/userblogs/:userId', function(req, res) {
    ...
    var thisUser = user.findOne({ '_id': userId },{mobile:1, email:1, basic:1, image:1, userType:1},function (err, thisUser) {
        if (!err){
            ...
            var internIds = ['5a1831f0bd2adb260055e352', '59c8a3683bee001b2643fa18', '59369dea8a9d754dbd9ead2a', '5a8583d66cbc3d68924591a7'];
